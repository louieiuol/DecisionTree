 ...
 * 
 * Copyright David Renie (University of Maryland, College Park), 2005 All rights
...
public class RoadNameComparator implements Comparator<Road> {
    ...
    public int compare(Road one, Road two) {
        ...
        final int startCityNameCompare = one.getStart().getName().compareTo(two.getStart().getName());
