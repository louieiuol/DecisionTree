...
public class City {
     ...
     *            color of the city
     */
    public City(final String name, final int x, final int y, int z, final int radius, final String color) {
        this.name = name;
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj != null && (obj.getClass().equals(this.getClass()))) {
            City c = (City) obj;
            return (pt.equals(c.pt) &&  Z == c.getZ() && (radius == c.radius) && color.equals(c.color));
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        hash = 37 * hash + ((Integer)Z).hashCode();
        hash = 37 * hash + radius;
    ...
    //checks if the city is a portal (isolated)
    public boolean isPortal(){
    	return color == null && radius == -1;
    }
}